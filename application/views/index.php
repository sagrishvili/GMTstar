                        ...
                        <div class="div-trans text-center">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12" >
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" required="required" placeholder="ელექტრონული ფოსტა">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" required="required" placeholder="პაროლი">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="div-trans text-center">
                            ...
                            <h3 ><i class="fa fa-code" ></i><span >STARTUP</span>  <i class="fa fa-code"></i></h3>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="სახელი გვარი">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" required="required" placeholder="ელექტრონული ფოსტა">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" required="required" placeholder="პირადი ნომერი">
                                </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <input type="password" class="form-control" required="required" placeholder="გაიმეორეთ პაროლი">
                                </div>
                                <div class="form-group">
